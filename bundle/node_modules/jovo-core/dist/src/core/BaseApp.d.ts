...
export declare class BaseApp extends Extensible {
     ...
     * @param {Function} callback
     */
    onRequest(callback: (handleRequest: HandleRequest) => void): void;
    /**
     * On response listener
     * @param {Function} callback
     */
    onResponse(callback: (handleRequest: HandleRequest) => void): void;
    /**
     * On error listener. Same as the onFail listener
     * @param {Function} callback
     */
    onError(callback: (handleRequest: HandleRequest) => void): void;
    /**
     * On fail listener
     * @param {Function} callback
     */
    onFail(callback: (handleRequest: HandleRequest) => void): void;
    /**
